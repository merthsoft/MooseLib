...
{
    public static string SerializeGrid(Merthsoft.Moose.MooseEngine.PathFinding.Grids.Grid grid)
    {
    ...
    public static Merthsoft.Moose.MooseEngine.PathFinding.Grids.Grid DeSerializeGrid(string gridString)
    {
        ...
        return Merthsoft.Moose.MooseEngine.PathFinding.Grids.Grid.CreateGridFrom2DArrayOfNodes(nodes);
    }
