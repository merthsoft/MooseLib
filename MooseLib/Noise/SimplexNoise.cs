...
namespace Merthsoft.Moose.MooseEngine.Noise;
...
public static class SimplexNoise
{
    ...
    public static float CalcPixel1D(int x, float scale) => Generate(x * scale) * 128 + 128;

    public static float CalcPixel2D(int x, int y, float scale) => Generate(x * scale, y * scale) * 128 + 128;

    public static float CalcPixel3D(int x, int y, int z, float scale) => Generate(x * scale, y * scale, z * scale) * 128 + 128;
